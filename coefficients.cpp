/*
Here are regrouped all functions needed to calculate coefficients of reflexion and transmission for indoor ray tracing

CODE FOR 5G RAY TRACING MUST BE ADAPTED, DO NOT USE THESE FUNCTIONS
*/
